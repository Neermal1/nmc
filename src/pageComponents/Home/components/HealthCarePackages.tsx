    ...
    <div className="layout component-padding black-color">
      <div className="flex flex-col gap-20">
        ...
        <div className="grid lg:grid-cols-6 gap-10">
          <div className="bg-[#BFD2F8] col-span-2 rounded-[8px] px-6 py-6 flex flex-col gap-4">
            <div
            ...
            <div className="text-[14px] font-medium">
              Choose a plan and get our health packages. Then get checked up for
              you and your loved once.
            </div>
            <div className="">
              <Image
                src={girl}
                        ...
                        {data?.details?.map((data, index: any) => {
                          return (
                            ...
                            >
                              ...
                              <div className="text-[18px]">{data?.service}</div>
                            </div>
                          );
                        })}
                      </div>
